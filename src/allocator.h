...
// To reallocate a block: ptr is the old block, old_size is its size, new_size is the new size.
// To free a block: ptr is the block, old_size is its size, new_size is 0.
typedef void* (*AllocFn)(void* ctx, void* ptr, size_t old_size, size_t new_size);
...
inline void* Realloc(Allocator a, void* ptr, size_t old_size, size_t new_size) {
  return a.alloc(a.ctx, ptr, old_size, new_size);
}

inline void Free(Allocator a, void* ptr, size_t size) {
