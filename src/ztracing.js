(function() {
  ...
  async function loadFromStream(stream, name, sizeHint, contentType) {
    ...
    const isGzip = contentType && (contentType === 'application/gzip' || contentType === 'application/x-gzip');
    ...
    Module.ccall('ztracing_begin_session', null, ['number', 'string'], [sessionId, name]);
